...
Celem pracy jest przetworzenie, scharakteryzowanie i analiza zebranych danych z punktówych pomiarów powietrza pod kątem występowania PM10 (zatem, takich pyłów, których średnica nie przekraczającza 10 μm) oraz wykazanie związków i prawidłowości dotyczących wysokości stężenia tych pyłów pod względem określonych kryteriów. 
